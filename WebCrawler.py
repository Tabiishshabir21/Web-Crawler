# Web Crawler :it will find all the web pages linked with the given website
# and After crawling the webpages, it will find all the emails and mobile
# numbers from that webpages and save them in a separate text file
# Developed by TABISH SHABIR......
import logging
   ...
   # Function to crawl a webpage and extract emails and mobile numbers
    ...
    def add_url_to_visit(self, url = ''):
        ...
        if url.startswith('https://') or url.startswith('http://'):
         ...
         new_url = 'https://nitsri.ac.in/'+ str(url) #original url + input url
    ...
    def run(self):
        ...
        print(1)
        i = 0 # ek page ki urls ke liye sirf, Homepage ki urls se emails aur mobile no. fetch krne me hi L lag jate h
        ...
        for url in self.urls_to_visit:
                  ...
                  if len(emails) and len(mobile_numbers): # agar emails aur mobile h page pe tabhi file edit karo
